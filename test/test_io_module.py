...
# 加载data_reader模块
data_reader_path = project_root / 'io' / 'data_reader.py'
spec = importlib.util.spec_from_file_location("data_reader", data_reader_path)
data_reader = importlib.util.module_from_spec(spec)
spec.loader.exec_module(data_reader)
IMUReader = data_reader.IMUReader
GNSSReader = data_reader.GNSSReader

# 加载time_aligner模块
time_aligner_path = project_root / 'io' / 'time_aligner.py'
spec = importlib.util.spec_from_file_location("time_aligner", time_aligner_path)
time_aligner = importlib.util.module_from_spec(spec)
spec.loader.exec_module(time_aligner)
TimeAligner = time_aligner.TimeAligner
